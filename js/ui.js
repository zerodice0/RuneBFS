define(['jquery', 'underscore'], function ($, _) {
    ...
    data["alertCBT"] = { "ja-JP": "注意：本エミュレータのデータは中国サーバーのデータを利用しています。", "zh-TW": "警告：正在使用測試服務器數據。", "en-US": "Warning:Currently using CBT server data.", "zh-CN": "警告：正在使用测试服务器数据。" };
    //rune panel
    data["evorune"] = { "ja-JP": "神碑拡張：", "zh-TW": "進階符文", "en-US": "Evolution Rune", "zh-CN": "进阶符文" };
